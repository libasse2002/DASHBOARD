...
$isChefDepartementQuery = "SELECT * FROM chef_departement WHERE utilisateur_id = $userId";
$isChefDepartementResult = mysqli_query($conn, $isChefDepartementQuery);
$isChefDepartement = mysqli_num_rows($isChefDepartementResult) > 0; // true si c'est un chef de département
...
$query = "
    ...
    WHERE f.statut = 'validée' AND f.utilisateur_id = $userId
";
...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu top">
            ...
            <?php endif; ?>
            <li class="active"><a href="fiches_validées.php"><i class='bx bxs-select-multiple bx-tada'></i><span>Fiches Validées</span></a></li>
